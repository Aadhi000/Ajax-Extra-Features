...
async def start(client, message):
    if message.chat.type in ['group', 'supergroup']:
        buttons = [
            [
                InlineKeyboardButton('𝐌𝐒𝐌 𝐀𝐃𝐌𝐈𝐍', url=f"https://t.me/MSMadminBot")
            ]
            ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('🔊 𝙲𝙷𝙰𝙽𝙽𝙴𝙻 🔊', url='https://t.me/msmOTT'),
            InlineKeyboardButton('💬 𝚄𝙿𝙳𝙰𝚃𝙴𝚂 💬', url='https://t.me/MSMchat')
            ],[      
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "🔥 𝐅𝐈𝐑𝐒𝐓 𝐉𝐎𝐈𝐍 𝐎𝐔𝐑 𝐂𝐇𝐀𝐍𝐍𝐄𝐋 🔥", url=invite_link.invite_link
                )
            ]
        ]
