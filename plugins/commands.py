...
async def start(client, message):
    if message.chat.type in ['group', 'supesupergroup'super'    ]
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚔️🛡 CHANNEL 🛡⚔️', url='https://t.me/HDCinem4U'),
            InlineKeyboardButton('💎 BOT UPDATES 💎', url='https://t.me/Bot_Updates_HDCinema4U')
            ],[      
        ...
        btn = [
            [
                InlineKeyboardButton(
                    "💎 JOIN CHANNNEL 💎", url= https://t.me/HDCinema4U
